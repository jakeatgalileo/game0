...
export default function LoadingScreen({ codeRef, bytes, lines, startedAt }: LoadingScreenProps) {
      ...
      <div className="grid min-h-0 flex-1 grid-cols-2 gap-4">
        ...
        <div className="min-h-0 overflow-hidden rounded-lg border bg-card"> 
          ...
          <div className="min-h-0 h-full max-h-full p-3">
            <TetrisLoadingGame captureKeyboardWhenFocusedOnly className="mx-auto h-full" />
          </div>
        </div>
      </div>
    </div>
