...
export function Chat({ className, onAssistantTurnEnd }: ChatProps) {
  ...
  return (
    <div className={cn("bg-background text-foreground flex h-full flex-col", className)}>
                  ...
                  switch (part.type) {
                    ...
                    case 'reasoning':
                      return (
                        ...
                        >
                          <ReasoningTrigger />
                          <ReasoningContent className="text-foreground">{part.text}</ReasoningContent>
                        </Reasoning>
                      );
                    default:
                      return null;
      ...
      <PromptInput onSubmit={handleSubmit} className="mx-auto w-full max-w-[48rem] px-4 pb-4 md:pb-6 border-border">
        <PromptInputTextarea
          value={input}
